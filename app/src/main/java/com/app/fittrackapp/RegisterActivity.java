            ...
            mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        databaseReference.child("email").setValue(inputEmail.getText().toString());
                        databaseReference.child("name").setValue(inputName.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
